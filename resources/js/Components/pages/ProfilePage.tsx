...
interface IProps{
    ...
    passwordUpdateRoute: string;
}
const ProfilePage = ({ auth, flash,ziggy,profileUpdateRoute,passwordUpdateRoute }: IProps) => {
    ...
    const handleUpdateProfile = (e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        router.post(route(profileUpdateRoute), form.data, {
            onSuccess: () => {
                form.clearErrors();
                router.reload();
            },
    ...
    const handleUpdatePassword = (e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        router.post(route(passwordUpdateRoute), formPassword.data, {
            onSuccess: () => {
